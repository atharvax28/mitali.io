...
```ts
{
  ...
  backgroundImage: "",   // path to hero background image — should be a portrait/people photography for best visual effect with the mouse-tracking reveal (e.g. "/temp-bg.png")
}
```
...
|-------|-------|-----------------|
| `temp-bg.png` | Hero background (full-screen) — should be a portrait/people photography for best effect with the mouse-tracking reveal | 1920x1080+ |
