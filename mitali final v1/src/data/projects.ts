...
export const projectsData: Record<string, ProjectDetail> = {
  'b2b-banking': {
    ...
    process: [
      ...
      { title: 'Design Process', substeps: ['Workflow Optimization', 'Document Hierarchy', 'Global Compliance Mapping'], image: '/images/case-studies/banking/design-process.png' },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          { title: 'High Fidelity Wireframe (Iteration 1)', image: '/images/case-studies/banking/group-34147.png' },
          { title: 'High Fidelity Wireframe (Interaction Detail)', image: '/images/case-studies/banking/group-34148.png' },
    ...
    sections: [
      {
        ...
        content: '"Innovation is the key to your company\'s survival. Rapid technology change challenges businesses but at the same time presents opportunities to flourish in the market, increase internal process efficiency, and optimise time and effort. Failing to do so is an invitation to lose business."',
        image: '/images/case-studies/innovation/d1.png'
      },
      {
        type: 'text-image',
        title: 'Literature Review',
        content: 'We looked at the overall picture to have a deeper understanding of trends and what catches a user\'s attention. This helped in speculating on future trends and establishing baseline expectations.',
        image: '/images/case-studies/innovation/d4.png'
      },
      {
        type: 'text-image',
        title: 'Website Analysis',
        content: 'We analyzed the current portal based on the VIMM model, Heuristics, and brand guidelines to understand its strengths and weaknesses. The analysis revealed a heuristic score of 63/100 and significant confusion caused by "False Clicks" in legacy carousels.',
        image: '/images/case-studies/portfolio-d3/d7-dis.png'
      },
      {
        type: 'text-image',
        title: 'Primary Research',
        content: 'We conducted dialogue discussions with 15 people from various functions. We discovered a general unawareness about the Innovation Department, heavily motive-driven user actions, and high email dependency. Users rarely landed on the home page organically.',
        image: '/images/case-studies/portfolio-d3/d7-disc-1.png'
      },
      {
        type: 'full-width-image',
        title: 'User Understanding & Empathy',
        image: '/images/case-studies/portfolio-d3/experience-map.png'
      },
      {
        type: 'metrics',
        title: 'Strategic Value Chain',
        items: [
          { value: '01', label: 'Aware' },
          { value: '02', label: 'Engage' },
          { value: '03', label: 'Incentivise' },
          { value: '04', label: 'Create Impact' }
        ]
      },
      {
        type: 'grid',
      ...
      },
      {
        ...
        content: 'We transitioned to a storytelling-first approach with human-centric visuals, clear feedback and microinteractions, and simplified layouts for faster display.',
        image: '/images/case-studies/innovation/d2.png'
      },
      {
        type: 'full-width-image',
  ...
  'product-design-portfolio': {
    ...
    year: '2022–2024',
    description: 'A comprehensive collection of design solutions ranging from board games for neurodiversity to physical health hardware.',
    ...
    solution: 'End-to-end service and product designs including physical games, app flows, and health hardware (TALK the TALK, TUNNEL).',
  ...
  'return-management': {
    ...
    year: '2024',
    description: 'Designing solutions for e-commerce return experiences to reduce friction and ecological impact.',
    coverImage: '/images/misc/Mitali portfolio 2024 (1)-12.jpg',
    challenge: 'High return rates and customer dissatisfaction due to product-reality mismatch and complex policies. 93.6% of customers have returned a product, mainly due to dissatisfaction.',
    solution: 'Simplified return flows, AI size recommendations, and eco-friendly incentives to encourage mindful purchasing and reduce the carbon footprint of returns.',
    role: 'UX Designer & Researcher',
    duration: '6 Months',
    tools: ['Figma', 'Maze', 'Optimal Workshop', 'Miro'],
    process: [
      { title: 'Research', substeps: ['User Interviews', 'Return Data Analysis'], image: '/images/misc/Mitali portfolio 2024 (1)-13.jpg' },
      { title: 'Insights', substeps: ['Demographic Study', 'Pain Point Identification'], image: '/images/misc/Mitali portfolio 2024 (1)-14.jpg' },
      { title: 'Strategy', substeps: ['Intervention Mapping', 'Eco-Incentive Design'], image: '/images/misc/Mitali portfolio 2024 (1)-15.jpg' }
    ],
    sections: [
      {
        type: 'metrics',
        ...
        items: [
          { value: '93.6%', label: 'Return Rate Experience' },
          { value: '71%', label: 'Product Dissatisfaction' },
          { value: '74%', label: 'Female Demographic' },
          { value: '61%', label: 'Metropolitan Reach' }
        ]
      },
      {
        type: 'grid',
        title: 'Design Solutions & Flows',
        items: [
          ...
          { title: 'Data Arch', image: '/images/misc/Mitali portfolio 2024 (1)-19.jpg' },
  ...
  'pet-coach': {
    id: 'pet-coach',
    title: 'PetCoach',
    category: 'Health & Hardware UX',
    year: '2024',
    description: 'Hardware and software ecosystem helping dog owners monitor and improve their pet\'s health and fitness.',
    coverImage: '/images/misc/pet-coach-preview.jpg',
    challenge: 'Pet owners lack data-driven insights into their dogs fitness levels, often leading to undetected health issues.',
    solution: 'Integrate a wearable sensor with a motivational mobile app to track activity, set goals, and receive professional coaching advice.',
    role: 'Product Designer',
    duration: '1 Year',
    tools: ['Figma', 'Industrial Design', 'App Architecture', 'User Testing'],
    process: [
      { title: 'Ideation', substeps: ['Sketching', 'Form Exploration'], image: '/images/misc/Mitali portfolio 2024 (1)-22.jpg' },
      { title: 'Design', substeps: ['CMF Study', 'Ergonomics'], image: '/images/misc/Mitali portfolio 2024 (1)-23.jpg' },
      { title: 'App Dev', substeps: ['UI Design', 'Data Visualization'], image: '/images/misc/Mitali portfolio 2024 (1)-26.jpg' }
    ],
    sections: [
      {
        type: 'grid',
        ...
        items: [
          ...
          { title: 'Ergonomics', image: '/images/misc/Mitali portfolio 2024 (1)-25.jpg' },
          { title: 'Dashboard', image: '/images/misc/Mitali portfolio 2024 (1)-27.jpg' },
          { title: 'Tracking', image: '/images/misc/Mitali portfolio 2024 (1)-28.jpg' },
          { title: 'Gamification', image: '/images/misc/Mitali portfolio 2024 (1)-29.jpg' },
          { title: 'User Testing', image: '/images/misc/Mitali portfolio 2024 (1)-30.jpg' }
        ]
      }
    ]
  }
