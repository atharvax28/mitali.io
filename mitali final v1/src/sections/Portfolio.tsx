...
function ProjectCard({ project, index, isVisible }: { project: { id: string; title: string; category: string; year: string; image: string; featured?: boolean }; index: number; isVisible: boolean }) {
  return (
    <Link
      ...
      <div className="relative overflow-hidden bg-exvia-subtle">
        <div className={cn(
          ...
          <img
            src={project.image}
            alt={project.title}
            className="w-full h-full object-contain transition-transform duration-700 ease-out-cubic group-hover:scale-105"
          />
        </div>
